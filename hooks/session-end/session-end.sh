...
if [ -n "$CLAUDE_PLUGIN_ROOT" ]; then
    sync_script="$CLAUDE_PLUGIN_ROOT/hooks/session-end/sync-to-google-sheets.py"
else
    sync_script="$CLAUDE_PROJECT_DIR/.claude/hooks/session-end/sync-to-google-sheets.py"
fi
